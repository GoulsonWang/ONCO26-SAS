...
%macro onco26_pipeline(
    ...
    %put NOTE: [1/9] Importing raw data...;
    ...
    %put NOTE: [7/9] Running KM survival analysis...;
    %km_analysis(indata=adtte);

    /* Step 8: Cox regression */
    %put NOTE: [8/9] Running Cox regression...;
    %cox_analysis(indata=adtte_merged);

    /* Step 9: Safety analysis */
    %put NOTE: [9/9] Running safety analysis...;
